...
export const getters = {
  ...
  'srr/testmode': numberGetter(),
  'srr/testmodeenabled': booleanGetter(),
  'srr/testmode3delay': numberGetter(),
  'srr/testmode3initialdelay': numberGetter(),
  'srr/testmode3punchcount': numberGetter(),
  'srr/messagessent': numberGetter(),
  'srr/messagesacked': numberGetter(),
  'srr/outgoingqueuecount': numberGetter(),
...
export const setters = {
  ...
  'srr/testmode': numberSetter(),
  'srr/testmodeenabled': booleanSetter(),
  'srr/testmode3delay': numberSetter(),
  'srr/testmode3initialdelay': numberSetter(),
  'srr/testmode3punchcount': numberSetter(),
