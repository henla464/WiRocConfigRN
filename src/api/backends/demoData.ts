...
export const demoData: Readonly<Partial<Record<GettablePropName, string>>> = {
  ...
  'wifimesh/enabled': '0',
  'wifimesh/gateway/enabled': '0',
  'wifimesh/nodenumber': '1',
  'wifimesh/ipnetworknumber': '0',
  'wifimesh/ipaddress': '',
  'wifimesh/interfacecreated': '0',
  'wifimesh/mac': '',
  'wifimesh/routetointerface': 'wlan0',
  'wifimesh/mpath': JSON.stringify({mpaths: []}),
