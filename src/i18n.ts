...
export const resources = {
  en: {
    translation: {
      ...
      'SRR-testläge': 'SRR test mode',
      'Aktivera testläge': 'Enable test mode',
      Testläge: 'Test mode',
      'TX bärvåg (omodulerad)': 'TX carrier (unmodulated)',
      'TX 0xAA-loop': 'TX 0xAA loop',
      'TX normala stämplingar': 'TX normal punches',
      'Initial fördröjning (sekunder)': 'Initial delay (seconds)',
      'Antal stämplingar (0 = obegränsat)': 'Number of punches (0 = unlimited)',
      'Fördröjning mellan meddelanden (tiondels sekunder)':
        'Delay between messages (tenths of a second)',
      'Hämta statistik': 'Fetch statistics',
      'Meddelanden skickade': 'Messages sent',
      'Meddelanden ackade': 'Messages acked',
      'Antal i utgående kö': 'Items in outgoing queue',
      'Andel lyckade': 'Success rate',
      'Andel misslyckade': 'Failure rate',
      Kanal: 'Channel',
      ...
      warn_device_time_out_of_sync: 'Device time out of sync',
    },
  },
  sv: {
    translation: {
      ...
      'SRR-testläge': 'SRR-testläge',
      'Aktivera testläge': 'Aktivera testläge',
      Testläge: 'Testläge',
      'TX bärvåg (omodulerad)': 'TX bärvåg (omodulerad)',
      'TX 0xAA-loop': 'TX 0xAA-loop',
      'TX normala stämplingar': 'TX normala stämplingar',
      'Initial fördröjning (sekunder)': 'Initial fördröjning (sekunder)',
      'Antal stämplingar (0 = obegränsat)':
        'Antal stämplingar (0 = obegränsat)',
      'Fördröjning mellan meddelanden (tiondels sekunder)':
        'Fördröjning mellan meddelanden (tiondels sekunder)',
      'Hämta statistik': 'Hämta statistik',
      'Meddelanden skickade': 'Meddelanden skickade',
      'Meddelanden ackade': 'Meddelanden ackade',
      'Antal i utgående kö': 'Antal i utgående kö',
      'Andel lyckade': 'Andel lyckade',
      'Andel misslyckade': 'Andel misslyckade',
      Kanal: 'Kanal',
      ...
      warn_device_time_out_of_sync: 'Enhetstiden är osynkroniserad',
    },
  },
} as const;
